...
<!-- Start main-content -->
    <div class="main-content">
        ...
        <section class="divider parallax layer-overlay overlay-deep" data-bg-img="http://placehold.it/1920x1275" data-parallax-ratio="0.7">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="section-content">
                    <div class="row ml-md-0 multi-row-clearfix">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 p-0 pr-15 pb-10">
                            <div class="trainer-item">
                                <div class="trainer-thumb"> <img src="http://placehold.it/450x450" alt="" class="img-fullwidth img-responsive"> </div>
                                <div class="trainer-info">
                                    <div class="social-network">
