                ...
                <div class="blog-posts single-post">
                    <article class="post clearfix mb-0">
                        <div class="entry-header">
                            <div class="post-thumb thumb"> <img src="http://placehold.it/1920x1275" alt="" class="img-responsive img-fullwidth"> </div>
                        </div>
                        <div class="entry-content">
                            ...
                            <div class="entry-meta mb-20">
                                <ul class="list-inline">
                                    <li>Posted: <span class="text-theme-colored"> 9/9/2015</span></li>
                            ...
                            <li>
                                <div class="media comment-author"> <a class="media-left" href="#"><img class="img-thumbnail" src="http://placehold.it/130x130" alt=""></a>
                                    <div class="media-body">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="media comment-author nested-comment"> <a href="#" class="media-left pt-20"><img alt="" src="http://placehold.it/130x130" class="img-thumbnail"></a>
